...
const initialState = {
    users: [{nom:'armel',temoignage:'je suis satisfait du travail'},{ nom:'julia',temoignage:'merci pour la creattion de mon site web'},{nom:'',temoignage:'merci pour la creation du site de ma fille'}],
    user: {}
}
